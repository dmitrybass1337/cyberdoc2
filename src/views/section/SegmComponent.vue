...
<div class="jumbotron">
    ...
    <div
      ...
      style="
        ...
        overflow-x: auto;"
    >
<p style="text-align: center; color: #008CBA; font-weight: bold;">СЕГМЕНТЫ ИНФОРМАЦИОННОЙ СИСТЕМЫ</p>
	...
	<h4 style="text-align: center; color: #E8E8E8;">В РАЗРАБОТКЕ</h4>
     <h3 style="text-align: center; color: #59BBD8;">Модуль учёта сегментов информационной системы.</h3>
</div>
   </div>
</template>
